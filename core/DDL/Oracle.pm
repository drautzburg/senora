# $Id: Oracle.pm,v 1.1 2011/03/25 14:36:25 ekicmust Exp $ 
#
...
(
  ...
  'java source'           => \&_create_java_source,
...
sub configure
{
  ...
  # dtz (usually wants "user_" or explicitly set":
  $attr{ 'view' }    = ( exists $args{ 'view'  }  ) ? $args{ 'view'  } : 'user';
  #
...
# dtz:
  $attr{ 'parclause'} = ( exists $args{ 'parclause'} ) ? $args{ 'parclause'} : 0;
...
sub _create_java_source
{
  print "xxx pulling java ..\n";
  return _display_source( @_, 'JAVA SOURCE' );
}
  ...
  my $stmt =
      "
       ...
       WHERE
              ...
              AND name  =  ? 
      ";
# xxx removed upper in name clause for Java
  if ( $view eq 'DBA' )
  {
    $stmt .=
      "
